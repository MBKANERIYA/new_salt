...
const Engagement = () => {
    ...
    const getUploadData = async () => {
        ...
        try {
            ...
            const categoryProducts = response.data.filter(item => item.subCategory === "Engagement Rings"); // Only Solitaire Rings
    ...
    const applyFilters = async (appliedFilters) => {
        ...
        try {
            ...
            const filteredProducts = response.data.updatedProducts.filter(item => item.subCategory === "Engagement Rings");
