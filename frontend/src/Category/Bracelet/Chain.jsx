...
const Chain = () => {
    ...
    const getUploadData = async () => {
        ...
        try {
            ...
            const categoryProducts = response.data.filter(item => item.subCategory === "Chain Bracelet");
    ...
    const applyFilters = async (appliedFilters) => {
        ...
        try {
            ...
            const filteredProducts = response.data.updatedProducts.filter(item => item.subCategory === "Chain Bracelet");
